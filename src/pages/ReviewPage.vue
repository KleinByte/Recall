...
.match-bans { display: flex; align-items: center; gap: 4px; min-width: max-content; margin-left: auto; padding: 0 14px; }.match-bans span { margin-right: 4px; color: var(--text-muted); font-size: 9px; letter-spacing: .65px; text-transform: uppercase; }.match-bans img { width: 25px; height: 25px; border: 1px solid var(--border-subtle); border-radius: 3px; object-fit: cover; filter: saturate(.72); }
.insight-shell { padding: 0; overflow: hidden; }.insight-tabs { display: flex; border-bottom: 1px solid var(--border-subtle); background: color-mix(in srgb, var(--surface-0) 48%, transparent); }.insight-tabs button { min-width: 150px; padding: 11px 16px; border: 0; border-bottom: 2px solid transparent; background: transparent; color: var(--text-muted); font: 10px var(--font-heading); letter-spacing: .55px; text-transform: uppercase; cursor: pointer; }.insight-tabs button.active { border-bottom-color: var(--cyan); color: var(--text-primary); }
.rvi-review { display: grid; grid-template-columns: minmax(240px, .65fr) minmax(460px, 1.35fr); align-items: center; min-height: 340px; padding: 12px 22px; background: radial-gradient(circle at 77% 50%, rgba(10,203,230,.055), transparent 38%); }.rvi-copy { padding-left: 12px; }.rvi-copy h2 { margin-top: 4px; color: var(--text-primary); font: 20px var(--font-heading); }.rvi-copy p { max-width: 44ch; color: var(--text-muted); font-size: 13px; line-height: 1.5; }.rvi-score { display: flex; align-items: baseline; gap: 8px; margin-top: 18px; }.rvi-score strong { color: var(--gold-bright); font: 34px var(--font-display); }.rvi-score span { color: var(--text-muted); font-size: 10px; letter-spacing: .65px; text-transform: uppercase; }
...
.highlight-title { color: currentColor; font-size: 10px; text-transform: uppercase; letter-spacing: .7px; }
...
.baseline-summary span { display: flex; justify-content: center; align-items: baseline; gap: 4px; padding: 7px; border-left: 1px solid var(--border-subtle); color: var(--text-muted); font-size: 10px; text-transform: uppercase; letter-spacing: .45px; }
...
.baseline-row footer span { display: flex; align-items: baseline; gap: 4px; }.baseline-row footer small { color: var(--text-muted); font-size: 10px; }.baseline-row footer strong { color: var(--text-primary); font-size: 11px; }
.baseline-scope { margin: var(--space-3) 0 0; font-size: 9px; text-align: right; }
.positive { color: var(--win); }.negative, .error { color: var(--loss); }
.owner-augment-context { display: grid; gap: 9px; padding-top: var(--space-3); }.owner-augment-context > header { display: flex; align-items: end; justify-content: space-between; gap: var(--space-3); }.owner-augment-context h3 { margin: 2px 0 0; color: var(--text-primary); font: 14px var(--font-heading); }.owner-augment-context > header > span { font-size: 10px; }.augment-grid { display: grid; grid-template-columns: repeat(4, minmax(210px, 1fr)); gap: 8px; }.policy-note { margin: 0; color: var(--text-muted); font-size: 9px; }
...
.kill-copy { min-width: 0; }.kill-copy > strong { color: var(--text-primary); font-size: 11px; }.kill-copy > strong span { margin-inline: 4px; color: var(--gold); font-size: 9px; font-weight: 500; text-transform: uppercase; }.kill-copy > span { margin-top: 2px; color: var(--text-muted); font-size: 9px; }
