...
.choice-head { min-height: 34px; background: var(--surface-2); color: var(--text-secondary); font: 12px var(--font-heading); letter-spacing: 1.2px; text-transform: uppercase; }
...
.role-line, .score-cell span, .record-cell span, .confidence-cell > span:last-child { color: var(--text-secondary); font-size: 12px; }
.current-tag { padding: 2px 5px; border: 1px solid var(--gold-dim); color: var(--gold); font-size: 11px; letter-spacing: .8px; text-transform: uppercase; }
...
.confidence { align-self: flex-start; padding: 3px 7px; border: 1px solid var(--border-subtle); border-radius: 999px; color: var(--text-secondary); font-size: 12px; text-transform: uppercase; }
...
.reason-chip { padding: 3px 6px; border-radius: 999px; background: var(--surface-3); color: var(--text-secondary); font-size: 12px; }
.breakdown { width: 100%; font-size: 12px; }.breakdown summary { cursor: pointer; color: var(--gold); }.breakdown div { display: flex; justify-content: space-between; margin-top: 3px; }
...
.selected-stats strong { color: var(--gold-bright); font: 18px var(--font-display); text-transform: capitalize; }.selected-stats span { color: var(--text-secondary); font-size: 12px; text-transform: uppercase; letter-spacing: .8px; }
.modifier-list { display: flex; flex-wrap: wrap; gap: var(--space-2); margin-top: var(--space-3); }
.modifier-list > span { padding: 4px 7px; border: 1px solid var(--win-dim); border-radius: 999px; color: var(--win); font-size: 12px; }.modifier-list > span.nerf { border-color: var(--loss-dim); color: var(--loss); }
.composition-bars { display: grid; gap: var(--space-2); margin-top: var(--space-4); }
.composition-bars > div { display: grid; grid-template-columns: 110px 1fr 30px; align-items: center; gap: var(--space-2); font-size: 12px; color: var(--text-secondary); }
...
.small { font-size: 12px; }.composition-card > .small { margin: var(--space-3) 0 0; }
...
.metric-card:first-child { border-left: 0; }.metric-card span { color: var(--ui-text-muted); font: var(--ui-text-label) var(--ui-font-heading); letter-spacing: .8px; text-transform: uppercase; }.metric-card strong { color: var(--ui-text-heading); font: 20px var(--ui-font-display); }.metric-card.score strong { color: var(--ui-live); }.metric-card.score i { color: var(--ui-text-muted); font-style: normal; }
...
.estimate-quality, .tempo-direction { padding: 4px 7px; border: 1px solid var(--border-subtle); border-radius: 999px; color: var(--text-secondary); font-size: var(--ui-text-label); letter-spacing: .6px; text-transform: uppercase; }.estimate-quality.strong { color: var(--win); border-color: var(--win-dim); }.estimate-quality.fair { color: var(--gold); }.tempo-direction.up { color: #39d8b0; border-color: rgba(57, 216, 176, .35); }.tempo-direction.down { color: var(--loss); border-color: var(--loss-dim); }
.resource-totals { display: grid; grid-template-columns: 1fr auto 1fr; align-items: end; gap: var(--space-4); margin-top: var(--space-4); }.resource-totals > div { display: flex; flex-direction: column; }.resource-totals span { color: var(--text-secondary); font-size: 12px; letter-spacing: .8px; text-transform: uppercase; }.resource-totals strong { color: var(--text-primary); font: 27px var(--font-display); }.resource-totals .enemy { text-align: right; }.resource-totals .ally strong { color: #59c8e5; }.resource-totals .enemy strong { color: #ed7784; }.resource-lead { align-items: center; padding: 4px 11px; border: 1px solid var(--border-subtle); border-radius: var(--radius-sm); background: var(--surface-0); }.resource-lead strong { font-size: 16px; }.resource-lead.ahead strong { color: var(--win); }.resource-lead.behind strong { color: var(--loss); }
...
.win-outlook { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: center; gap: var(--space-4); margin-top: var(--space-4); padding: 12px 14px; border-left: 3px solid var(--gold); background: color-mix(in srgb, var(--gold-dim) 12%, var(--surface-0)); }.win-outlook.favored { border-left-color: var(--win); }.win-outlook.danger { border-left-color: var(--loss); }.win-outlook > div:first-child { display: flex; flex-direction: column; min-width: 88px; }.win-outlook span { color: var(--text-secondary); font-size: 12px; }.win-outlook > div:first-child > span { letter-spacing: .9px; text-transform: uppercase; }.win-outlook > div:first-child strong { color: var(--gold-bright); font: 29px var(--font-display); }.confidence-copy { display: flex; flex-direction: column; gap: 3px; }.confidence-copy strong { color: var(--text-primary); font: 12px var(--font-heading); }.estimate-note { margin: 9px 0 0; color: var(--text-muted); font-size: 12px; }.tempo-factors { display: flex; justify-content: center; gap: 6px; flex-wrap: wrap; margin-top: 7px; }.tempo-factors span { padding: 4px 7px; border: 1px solid var(--border-subtle); border-radius: 999px; background: var(--surface-0); color: var(--text-secondary); font-size: 11px; }
...
.live-identity { min-width: 0; display: flex; flex-direction: column; }.live-identity strong, .live-identity span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.live-identity strong { font-size: 12px; }.live-identity span, .live-cs { color: var(--text-secondary); font-size: 12px; }
...
.loadout-items { display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--space-2); margin-top: var(--space-3); }.loadout-items figure { margin: 0; min-width: 0; }.loadout-items img { width: 100%; aspect-ratio: 1; object-fit: cover; border: 1px solid var(--border-strong); border-radius: var(--radius-sm); }.loadout-items figcaption { margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-secondary); font-size: 11px; }
.loadout-meta { display: flex; flex-direction: column; gap: 3px; margin-top: var(--space-3); color: var(--text-secondary); font-size: 12px; }
.live-events { display: grid; margin-top: var(--space-2); }.live-events article { display: grid; grid-template-columns: 35px 12px minmax(0, 1fr); align-items: start; gap: var(--space-2); padding: var(--space-2) 0; border-bottom: 1px solid var(--border-subtle); }.live-events time { color: var(--gold); font-size: 11px; }.event-dot { color: var(--gold); font-size: var(--ui-text-micro); }.live-events div { min-width: 0; display: flex; flex-direction: column; }.live-events strong { font-size: 11px; }.live-events div span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-secondary); font-size: 12px; }
