...
.live-events { display: grid; margin-top: var(--space-2); }.live-events article { display: grid; grid-template-columns: 35px 12px minmax(0, 1fr); align-items: start; gap: var(--space-2); padding: var(--space-2) 0; border-bottom: 1px solid var(--border-subtle); }.live-events time { color: var(--gold); font-size: 11px; }.event-dot { color: var(--gold); font-size: 10px; }.live-events div { min-width: 0; display: flex; flex-direction: column; }.live-events strong { font-size: 11px; }.live-events div span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-secondary); font-size: 12px; }
