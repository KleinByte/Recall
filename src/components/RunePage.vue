...
.rune-tree h4 small { margin-left: auto; color: var(--text-muted); font: 9px var(--font-body); letter-spacing: .35px; }
...
.shard-divider { display: flex; align-items: center; gap: 8px; color: var(--text-muted); font-size: 8px; letter-spacing: .8px; text-transform: uppercase; }
...
.classic-tabs button { min-height: 28px; border: 0; border-radius: 4px; background: transparent; color: var(--text-muted); font: 10px var(--font-heading); letter-spacing: .55px; text-transform: uppercase; cursor: pointer; }
...
.classic-capture-note span { color: var(--text-muted); font-size: 10px; line-height: 1.35; }
...
.classic-rune-legend strong { color: var(--text-secondary); font-size: 10px; }
.classic-rune-legend small { color: var(--text-muted); font-size: 9px; }
...
.data-note { margin: 7px 1px 0; color: var(--text-muted); font-size: 10px; line-height: 1.4; }
...
.rune-results h4 { grid-column: 1 / -1; margin: 0; color: var(--text-secondary); font: 10px var(--font-heading); letter-spacing: .7px; text-transform: uppercase; }
...
.rune-results strong { font-size: 10px; }
.rune-results small { color: var(--text-muted); font-size: 9px; line-height: 1.35; }
...
@media (max-width: 700px) {
  ...
  .mastery-unavailable span { font-size: 9px; }
}
</style>
