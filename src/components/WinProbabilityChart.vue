...
.probability-panel > header { display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 16px 18px; border-bottom: 1px solid var(--border-subtle); }.eyebrow { color: var(--gold); font-size: 9px; letter-spacing: .8px; text-transform: uppercase; }.probability-panel h2 { margin: 3px 0 2px; color: var(--text-primary); font: 18px var(--font-heading); }.probability-panel header p { margin: 0; color: var(--text-muted); font-size: 10px; }
.final-reading { display: flex; flex-direction: column; align-items: flex-end; }.final-reading span { color: var(--text-muted); font-size: 8px; text-transform: uppercase; }.final-reading strong { color: #65d4ef; font: 22px var(--font-display); }.final-reading small { color: var(--text-secondary); font-size: 9px; }
...
.axis { position: absolute; left: 8px; z-index: 1; color: var(--text-muted); font-size: 8px; pointer-events: none; }.axis.blue { top: 7px; color: #67d5ef; }.axis.even { top: 50%; transform: translateY(-50%); }.axis.red { bottom: 7px; color: #ef7b88; }.time { position: absolute; bottom: 7px; color: var(--text-muted); font-size: 8px; }.time.start { left: 8px; }.time.end { right: 8px; }
.crosshair { position: absolute; top: 0; bottom: 0; width: 1px; background: rgba(255,255,255,.45); pointer-events: none; }.point { position: absolute; width: 10px; height: 10px; transform: translate(-50%,-50%); border: 2px solid var(--surface-0); border-radius: 50%; background: #36c4e8; box-shadow: 0 0 9px rgba(54,196,232,.6); pointer-events: none; }.tooltip { position: absolute; z-index: 3; top: 12px; display: flex; flex-direction: column; gap: 3px; min-width: 170px; padding: 9px 10px; transform: translateX(9px); border: 1px solid var(--border-strong); border-radius: 6px; background: rgba(5,12,24,.96); color: var(--text-secondary); font-size: 9px; pointer-events: none; }.tooltip.flip { transform: translateX(calc(-100% - 9px)); }.tooltip strong { color: var(--gold-bright); }.blue-copy { color: #67d5ef; }.red-copy { color: #ef7b88; }.tooltip small { color: var(--text-muted); }
.probability-panel > footer { display: flex; align-items: center; gap: 16px; padding: 9px 14px; border-top: 1px solid var(--border-subtle); color: var(--text-secondary); font-size: 9px; }.probability-panel footer span { display: inline-flex; align-items: center; gap: 5px; }.probability-panel footer i { width: 8px; height: 8px; border-radius: 50%; }.blue-dot { background: #36c4e8; }.red-dot { background: #e45868; }.probability-panel footer small { margin-left: auto; color: var(--text-muted); }.empty { padding: 50px 18px; color: var(--text-muted); text-align: center; }
</style>
