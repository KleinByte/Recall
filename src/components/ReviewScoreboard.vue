...
.role-cell { display: flex; flex-direction: column; align-items: center; gap: 3px; color: var(--ui-text-muted); font-size: 11px; text-transform: uppercase; }.role-cell img { width: 20px; height: 20px; object-fit: contain; opacity: .82; }.role-cell.aram img { width: 24px; height: 22px; opacity: 1; filter: drop-shadow(0 0 4px color-mix(in srgb, var(--ui-team-blue) 30%, transparent)); }.role-cell.aram span { color: var(--ui-team-blue); font-size: 10px; }
