...
.team-board { overflow: visible; border: 1px solid var(--border-subtle); border-radius: 13px; background: color-mix(in srgb, var(--surface-1) 92%, #0b1019); }
.team-board.blue { --team: #18bce8; }.team-board.red { --team: #ff4d2e; }
.team-head { display: grid; grid-template-columns: minmax(210px, 1.4fr) minmax(190px, .9fr) 120px 135px minmax(220px, 1fr); align-items: center; gap: 12px; min-height: 52px; padding: 8px 16px; border-bottom: 1px solid var(--border-subtle); background: rgba(255,255,255,.018); }
.team-result { display: flex; align-items: baseline; gap: 24px; }.team-result strong { color: var(--team); font: 14px var(--font-heading); text-transform: uppercase; }.team-result span { color: var(--text-secondary); font-size: 12px; }
.team-objectives { display: flex; align-items: center; gap: 13px; color: var(--text-muted); font-size: 11px; }.team-objectives span { display: inline-flex; align-items: center; gap: 5px; }.team-objectives svg { color: color-mix(in srgb, var(--team) 55%, var(--text-muted)); }
.team-total { color: var(--text-muted); font-size: 11px; text-transform: uppercase; letter-spacing: .5px; }.team-total strong { color: var(--text-secondary); font-size: 14px; }
.team-bans { display: flex; align-items: center; justify-content: flex-end; gap: 4px; min-width: 0; }.team-bans span { margin-right: 5px; color: var(--text-muted); font-size: 12px; text-transform: uppercase; }.team-bans img { width: 25px; height: 25px; border: 1px solid var(--border-subtle); border-radius: 3px; object-fit: cover; filter: saturate(.72); }
...
.player-labels { min-height: 27px; border-bottom: 1px solid color-mix(in srgb, var(--border-subtle) 60%, transparent); color: var(--text-muted); font-size: 11px; letter-spacing: .65px; text-transform: uppercase; }.player-labels span:not(:first-child) { text-align: center; }
.player-row { min-height: 62px; border-bottom: 1px solid color-mix(in srgb, var(--border-subtle) 58%, transparent); }.player-row:last-child { border-bottom: 0; }.player-row.owner { background: linear-gradient(90deg, color-mix(in srgb, var(--gold) 11%, transparent), transparent 48%); box-shadow: inset 3px 0 var(--gold); }
.player-identity { display: flex; align-items: center; gap: 7px; min-width: 0; }.portrait-wrap { position: relative; flex: 0 0 42px; }.portrait-wrap > img { width: 42px; height: 42px; border: 2px solid var(--team); border-radius: 50%; object-fit: cover; }.portrait-wrap > strong { position: absolute; right: -2px; bottom: -2px; display: grid; place-items: center; min-width: 17px; height: 17px; padding: 0 2px; border-radius: 9px; background: var(--surface-0); color: var(--text-primary); font-size: 11px; box-shadow: 0 0 0 1px var(--team); }
.spells { display: grid; gap: 2px; flex: 0 0 auto; }.spells img { width: 18px; height: 18px; border-radius: 3px; }
.player-name { display: flex; flex-direction: column; min-width: 0; margin-left: 2px; }.player-name strong { overflow: hidden; color: var(--text-primary); font-size: 13px; text-overflow: ellipsis; white-space: nowrap; }.player-row.owner .player-name strong { color: var(--gold-bright); }.player-name span { margin-top: 2px; color: var(--text-muted); font-size: 12px; }
.place-cell { display: grid; place-items: center; }.place-cell > span { min-width: 42px; padding: 6px 7px; border-radius: 6px; background: var(--surface-3); color: var(--text-secondary); font: 12px var(--font-heading); text-align: center; }.place-cell > span.mvp { background: color-mix(in srgb, var(--gold) 22%, var(--surface-3)); color: var(--gold-bright); }
.role-cell { display: flex; flex-direction: column; align-items: center; gap: 3px; color: var(--text-muted); font-size: 11px; text-transform: uppercase; }.role-cell img { width: 20px; height: 20px; object-fit: contain; opacity: .82; }.role-cell.aram img { width: 24px; height: 22px; opacity: 1; filter: drop-shadow(0 0 4px rgba(103, 210, 234, .3)); }.role-cell.aram span { color: #7bc7dc; font-size: 10px; }
.build-cell { display: grid; grid-template-columns: repeat(7, 27px); gap: 3px; justify-content: center; }.build-cell img, .empty-item { width: 27px; height: 27px; border: 1px solid var(--border-subtle); border-radius: 3px; background: color-mix(in srgb, var(--surface-3) 70%, transparent); object-fit: cover; }.empty-item { opacity: .38; }
.number-cell { display: flex; flex-direction: column; align-items: center; gap: 3px; font-variant-numeric: tabular-nums; }.number-cell strong { color: var(--text-primary); font-size: 13px; }.number-cell span { color: var(--text-muted); font-size: 11px; }.number-cell span.accent { color: var(--gold-bright); }
.damage-cell { display: flex; flex-direction: column; gap: 6px; min-width: 0; font-variant-numeric: tabular-nums; }.damage-cell strong { color: var(--text-primary); font-size: 12px; text-align: right; }.damage-cell > span { height: 5px; overflow: hidden; border-radius: 4px; background: var(--surface-3); }.damage-cell i { display: block; height: 100%; border-radius: inherit; background: var(--team); }
