...
.team-bans { display: flex; align-items: center; justify-content: flex-end; gap: 4px; min-width: 0; }.team-bans span { margin-right: 5px; color: var(--text-muted); font-size: 10px; text-transform: uppercase; }.team-bans img { width: 25px; height: 25px; border: 1px solid var(--border-subtle); border-radius: 3px; object-fit: cover; filter: saturate(.72); }
...
.player-labels { min-height: 27px; border-bottom: 1px solid color-mix(in srgb, var(--border-subtle) 60%, transparent); color: var(--text-muted); font-size: 9px; letter-spacing: .65px; text-transform: uppercase; }.player-labels span:not(:first-child) { text-align: center; }
...
.player-identity { display: flex; align-items: center; gap: 7px; min-width: 0; }.portrait-wrap { position: relative; flex: 0 0 42px; }.portrait-wrap > img { width: 42px; height: 42px; border: 2px solid var(--team); border-radius: 50%; object-fit: cover; }.portrait-wrap > strong { position: absolute; right: -2px; bottom: -2px; display: grid; place-items: center; min-width: 17px; height: 17px; padding: 0 2px; border-radius: 9px; background: var(--surface-0); color: var(--text-primary); font-size: 9px; box-shadow: 0 0 0 1px var(--team); }
.spells { display: grid; gap: 2px; flex: 0 0 auto; }.spells img { width: 18px; height: 18px; border-radius: 3px; }
.player-name { display: flex; flex-direction: column; min-width: 0; margin-left: 2px; }.player-name strong { overflow: hidden; color: var(--text-primary); font-size: 13px; text-overflow: ellipsis; white-space: nowrap; }.player-row.owner .player-name strong { color: var(--gold-bright); }.player-name span { margin-top: 2px; color: var(--text-muted); font-size: 10px; }
.place-cell { display: grid; place-items: center; }.place-cell > span { min-width: 42px; padding: 6px 7px; border-radius: 6px; background: var(--surface-3); color: var(--text-secondary); font: 10px var(--font-heading); text-align: center; }.place-cell > span.mvp { background: color-mix(in srgb, var(--gold) 22%, var(--surface-3)); color: var(--gold-bright); }
.role-cell { display: flex; flex-direction: column; align-items: center; gap: 3px; color: var(--text-muted); font-size: 9px; text-transform: uppercase; }.role-cell img { width: 20px; height: 20px; object-fit: contain; opacity: .82; }.role-cell.aram img { width: 24px; height: 22px; opacity: 1; filter: drop-shadow(0 0 4px rgba(103, 210, 234, .3)); }.role-cell.aram span { color: #7bc7dc; font-size: 8px; }
