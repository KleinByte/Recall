...
describe("desktop page layout", () => {
  ...
  it("sets the review scoreboard out as lane matchups that open independently", () => {
    ...
    expect(review).toContain("matchupComparisonGroups(row.left, row.right)")
    expect(review).toContain('class="comparison-sheet"')
    expect(review).toContain('class="compare-row"')
  ...
  it("uses League role art and shows interactive rune pages throughout reviews", () => {
    ...
    expect(review).toContain('align="left" compact')
    expect(review).toContain('align="right" compact')
    ...
    expect(review).toContain('class="comparison-sheet"')
    expect(review).not.toContain('class="compare-stats"')
