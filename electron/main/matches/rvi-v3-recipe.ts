...
export const RVI_V3_RECIPE_DEFINITION_ID =
  "recall.rvi.v3.detail-definition.2026-08-09.r1" as const
export const RVI_V3_METRIC_REGISTRY_VERSION =
  "recall.rvi.v3.metric-registry.2026-08-09.r1" as const
export const RVI_V3_TIMELINE_POLICY_VERSION =
  "recall.rvi.v3.timeline.12s-1200u.2026-08-09.r1" as const
export const RVI_V3_VECTOR_POLICY_VERSION =
  "recall.rvi.v3.eight-vectors.fixed-denominator.2026-08-09.r1" as const
...
export const RVI_V3_VECTOR_DEFINITIONS: readonly RviVectorDefinitionV3[] = Object.freeze([
  Object.freeze({ key: "threat", label: "Threat", shortLabel: "Threat", description: "Damage pressure and direct conversion.", diagnosticOnly: false }),
  Object.freeze({ key: "teamfighting", label: "Teamfighting", shortLabel: "Teamfight", description: "Presence and outcomes in recorded group fights.", diagnosticOnly: false }),
  ...
  Object.freeze({ key: "initiative_pressure", label: "Initiative & Pressure", shortLabel: "Initiative", description: "Early movement and pressure from retained event proxies.", diagnosticOnly: true }),
])
...
export function rviRecipeDefinitionV3(
  ...
  return Object.freeze({
    ...
    aggregation: Object.freeze({
      matchVectorMethod: "fixed_denominator_arithmetic" as const,
      longitudinalMethod: "weighted_mean_no_score_shrinkage" as const,
      headlineSource: "stored_exact_recipe_role_fit" as const,
      missingScoredEvidence: "withhold_vector" as const,
      diagnosticGradeInfluence: 0 as const,
    }),
